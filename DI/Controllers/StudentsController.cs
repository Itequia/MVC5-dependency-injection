...
namespace DI.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Dni,Email,SchoolId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Dni,Email,SchoolId")] Student student)
        {
            if (ModelState.IsValid)
            {
